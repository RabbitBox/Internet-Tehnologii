...
namespace Test_1.Controllers
{
    public class MoviesController : Controller
    {
        ...
        static List<Client> lista = new List<Client>() { new Client() { Name = "Aleksandar Stojmenski", MovieCard = "1234",Address = "Partizanski Odredi 64",Telephone = "075444222",Age = 25},
        ...
        public ActionResult Random()
        {
            ...
            model.movie = m;                           // movie e objekt zatoa movie = m 
            model.customers = lista;
            return View(model);
        }
        public ActionResult ShowClient()
        {
            Client model = lista.ElementAt(1);
            return View(model);
        }
    }
}